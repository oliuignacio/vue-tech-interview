...
function createCustomer() {
  ...
  if (sanitize(input)) {
    ...
    console.log(
      ...
      customers.value[0].name,
      customers.value[0].age
    );
    customerName.value = "";
    age.value = "";
    return;
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="(customer, index) in customers">
              <td>
                <p v-if="customer.id">{{ customer.id }}</p>
              ...
              <td>
                ...
                <span v-else>
                  <p v-if="customer.name"
                    v-bind:class=
                    " {
                      color_red: customer.name.charAt(0) == 'M',
                      color_blue: customer.name.charAt(0) == 'K',
                    }"
                    >
                  {{ customer.name }}
                  </p>
              ...
              <td>
                ...
                <span v-else>
                  ...
                  <!-- Botón para borrar -->
                  <button @click="erase(index)" class="btn btn-danger mb-2">
                    ERASE
                  </button>
                </span>
              </td>
